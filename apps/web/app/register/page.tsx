...
export default function RegisterPage() {
  ...
  return (
    <main className="auth-surface relative flex min-h-screen items-center justify-center px-4 py-10">
      <div className="absolute right-4 top-4">
        <ThemeToggle />
      </div>
      <Card className="w-full max-w-lg overflow-hidden border-slate-200 bg-white/95 shadow-2xl shadow-[#005652]/10 backdrop-blur dark:border-slate-800 dark:bg-slate-950/90">
